...
Em.I18n.translations = {
  ...
  'admin.highAvailability.rollback.step2.body':
    '<ol>' +
      ...
      '<div class="code-snippet">sudo su -l {0} -c \'/opt/vse/hadoop/bin/hdfs dfsadmin -safemode enter\'</div></li>' +
      '<li>Once in Safe Mode, create a Checkpoint:' +
      '<div class="code-snippet">sudo su -l {0} -c \'/opt/vse/hadoop/bin/hdfs dfsadmin -saveNamespace\'</div></li>' +
      '</ol>',
  ...
  'admin.highAvailability.wizard.step8.body':
    ...
    '<div class="code-snippet">sudo su -l {0} -c \'/opt/vse/hadoop/bin/hdfs zkfc -formatZK\'</div></li>' +
    '</div>' +
    '<div class="alert alert-info">' +
    '<ol start="3">' +
    ...
    '<div class="code-snippet">sudo su -l {0} -c \'/opt/vse/hadoop/bin/hdfs namenode -bootstrapStandby\'</div></li>' +
    '</ol>' +
    '</div>' +
  ...
  'admin.highAvailability.wizard.step6.body':
    ...
    '<div class="code-snippet">sudo su -l {0} -c \'/opt/vse/hadoop/bin/hdfs namenode -initializeSharedEdits\'</div></li>' +
  ...
  'services.reassign.step5.body.namenode_ha':
      ...
      '<div class="code-snippet">sudo su -l {3} -c \'/opt/vse/hadoop/bin/hdfs zkfc -formatZK\'</div></li>' +
      '</ol>' +
      '</div>' +
      '<div class="alert alert-info">' +
      '<ol start="3">' +
      ...
      "<div class='code-snippet'>sudo su -l {3} -c '/opt/vse/hadoop/bin/hdfs namenode -bootstrapStandby'</div></li>" +
      '</ol>' +
      '</div>',
